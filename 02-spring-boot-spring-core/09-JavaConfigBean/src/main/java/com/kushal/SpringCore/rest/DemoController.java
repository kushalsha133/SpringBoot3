...
public class DemoController {
    ...
    //you can mark one as @Primary then we won't have to give @Qualifier but the primary implementation will be used always
    //if we give a namein @bean then we need ot use that in qualifier
    @Autowired
    //private DemoController(@Qualifier("swimCoach") Coach myCoach){
    private DemoController(@Qualifier("aquatic") Coach myCoach){
